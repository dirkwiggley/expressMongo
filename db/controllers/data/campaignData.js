    ...
    return  [
        ...
        { 
            ...
            metaData: {
                ...
                hindrances: [
                    { name: 'All Thumbs', value: 1 },
                    { name: 'Anemic', value: 1 },
                    { name: 'Arrogant', value: 2 },
                    { name: 'Bad Eyes - Minor', value: 1 },
                    { name: 'Bad Eyes - Major', value: 2 },
                    { name: 'Bad Luck', value: 2 },
                    { name: 'Big Mouth', value: 1 },
                    { name: 'Blind', value: 2 },
                    { name: 'Bloodthirsty', value: 2 },
                ],
                skills: [
                    { name: 'Academics', attribute: 'Smarts' },
                    { name: 'Athletics (Agility)', attribute: 'Agility' },
